            ...
            <div class="flex flex-col md:flex-row -mx-4">
                <div class="md:flex-1 px-4">
                    <div class=" rounded-lg mb-4 border border-gray-500">
                        <img class=" h-full object-contain" src="{jersey.imageUrl}" alt="Product Image" aria-hidden=true>
                    </div>
                ...
                <div class="md:flex-1 ml-24 pt-14">
                    <h2 class="text-2xl font-bold text-gray-800  mb-2">{jersey.playerName ? `${jersey.playerName} - ` : ''}{jersey.team}</h2>
                    <div class="flex mb-4">
                        <div class="mr-4">
